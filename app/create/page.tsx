...
export default function CreateSessionPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Redirect to the new session (mock ID)
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-black mb-2">Start an AMA Session</h1>
          <p className="text-gray-600">Create a new Ask Me Anything session for your community</p>
        </div>

        {/* Form */}
        <Card className="shadow-lg border-0">
          <CardHeader>
            <CardTitle className="text-xl font-semibold text-black">Session Details</CardTitle>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className={`h-12 ${errors.title ? "border-red-500 focus:border-red-500" : "border-gray-200 focus:border-purple-500"}`}
                  required
                />
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  rows={5}
                />
                <p className="text-xs text-gray-500">Give your audience context about what topics you'll be covering</p>
              </div>
        ...
        <div className="mt-8 p-6 bg-gray-50 rounded-lg">
          <h3 className="font-semibold text-black mb-3">Tips for a great AMA:</h3>
          <ul className="space-y-2 text-sm text-gray-700">
            <li>• Choose a clear, descriptive title that explains your expertise</li>
            <li>• Set expectations about how long you'll be available</li>
            <li>• Engage with questions promptly to keep the conversation flowing</li>
